...
function AuthValue() {
  const { onPost: loginOnPost } = useApi(
    'https://ktcux.sse.codesandbox.io/users/login'
  )
  const { onPost: registerOnPost } = useApi(
    'https://ktcux.sse.codesandbox.io/users/register'
  )
